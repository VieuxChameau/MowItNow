...
/**
 * Test class for the Turn Left Instruction
 */
public class MowerInstructionLeftTest extends AbstractMowerInstructionTest {

	private static final int X_POSITION = 0;

	private static final int Y_POSITION = 0;

	public MowerInstructionLeftTest() {
		super(MowerInstruction.LEFT);
	}
