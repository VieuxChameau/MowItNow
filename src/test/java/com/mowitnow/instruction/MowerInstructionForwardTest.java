...
/**
 * Test class for the Forward Instruction
 */
public class MowerInstructionForwardTest extends AbstractMowerInstructionTest {

	private static final int X_POSITION = 1;

	private static final int Y_POSITION = 1;

	public MowerInstructionForwardTest() {
		super(MowerInstruction.FORWARD);
	}
	...
	public void testProcessFromNorth() {
		...
		// EXPECTED
		final Position expectedPosition = new Position(X_POSITION, Y_POSITION + 1, NORTH);
	...
	public void testProcessFromEast() {
		...
		// EXPECTED
		final Position expectedPosition = new Position(X_POSITION + 1, Y_POSITION, EAST);
	...
	public void testProcessFromSouth() {
		...
		// EXPECTED
		final Position expectedPosition = new Position(X_POSITION, Y_POSITION - 1, SOUTH);
	...
	public void testProcessFromWest() {
		...
		// EXPECTED
		final Position expectedPosition = new Position(X_POSITION - 1, Y_POSITION, WEST);
